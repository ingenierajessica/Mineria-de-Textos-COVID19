...
// AND PLEASE CUT & PASTE THE CODE BELLOW JUST AFTER DE TAG <div id="holder">
	...
	<div id="copy" style="height: 75px; position: absolute; bottom: 0px; left:0px; border: none; width: 100%;">
		<div id="free-flash-header" style="width:820px;margin:0 auto;text-align:right;position:relative;bottom:0px;margin-top:63px;color:#363636;font-size:10px;font-family:Verdana"><strong>descargar musica gratis</strong> en <a href="https://lamusicagratis.com">lamusicagratis.com</a></div>																			 
	</div>	
	<!--END OF TERMS OF USE-->	
*/